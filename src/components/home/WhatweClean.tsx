...
const WhatweClean = () => {
  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-2 lg:py-14 mx-auto">
    ...
    <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      ...
      At Pure Cleaning Services, we offer professional and reliable cleaning solutions to keep your home and workplace spotless. Whether you need routine maintenance or a deep, thorough clean, our dedicated team is here to deliver exceptional results.
      </p>
    </div>
    {/* End Title */}
    {/* Grid */}
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {/* Card */}
      <div
        className="group flex flex-col h-full border border-gray-300 hover:border-gray-300 hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl py-5 px-4 md:px-5    dark:focus:border-transparent "
      >
